...
import { designTaskArchitecture } from '@/lib/agents/architect';
...
/**
 * Genera el diseño técnico de una HU compleja (arquitectura + descomposición) y
 * lo persiste. Advisory (no cambia estado). Lo llama el agente Arquitecto (Dax).
 */
export async function POST(
  ...
  let design: string;
  try {
    design = await designTaskArchitecture({
